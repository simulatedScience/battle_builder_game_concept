"""
Plot a build's parameters: ATK, DEF, REV, HP in a radar chart.
...
def plot_build_radar(ax: plt.Axes, build: "Build", max_values: tuple[int, int, int, int], color: str|None = None) -> None:
    """
    Plot a build's parameters: ATK, DEF, REV, HP in a radar chart.
